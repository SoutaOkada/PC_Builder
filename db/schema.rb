...
ActiveRecord::Schema.define(version: 2022_08_13_145120) do
  ...
  create_table "cpu_coolers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pc_id"], name: "index_cpu_coolers_on_pc_id"
  end
  ...
  create_table "drives", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pc_id"], name: "index_drives_on_pc_id"
  end
  ...
  create_table "fans", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pc_id"], name: "index_fans_on_pc_id"
  end
  ...
  create_table "others", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pc_id"], name: "index_others_on_pc_id"
  end
  ...
  create_table "systems", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["pc_id"], name: "index_systems_on_pc_id"
  end
